...
namespace DinamicAspect.Attributes
{
	...
	public class NumberAttribute : DependencyAttribute
	{
		...
		public NumberAttribute(string[] fields, string[][] conditions, string[] values) : base(fields, conditions, values) { }
		public NumberAttribute(string[] fields, string[][] conditions, string values) : base(fields, conditions, values) { }
		public NumberAttribute(string values) : base(values) { }
		public NumberAttribute(string conditions, string values) : base(conditions, values) { }
		...
		public override string StrongValidate(object newValue, object obj = null)
		{
			if (CanApply(obj))
			{
				try
				{
					...
					if (value < Min)
					{
						return $"Less than minimal value ({Min})";
					}
					if (value > Max)
					{
						return $"More than maximal value ({Max})";
					}
				}
				catch (Exception)
				{
